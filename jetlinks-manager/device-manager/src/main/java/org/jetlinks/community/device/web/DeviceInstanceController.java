...
public class DeviceInstanceController implements
    ...
    @PostMapping("/{productId:.+}/histry_data")
    @QueryAction
    @QueryOperation(summary = "查看属性历史数据")
    public Mono<PagerResult<ChartDataResponse>> queryHistryDataOwn(@PathVariable @Parameter(description = "产品ID")String productId, @RequestBody QueryDataRequest queryDataRequest){
     return deviceDataService.queryHistryDataOwn(productId,queryDataRequest);
//        PagerResult<String> pagerResult = new PagerResult<>();
